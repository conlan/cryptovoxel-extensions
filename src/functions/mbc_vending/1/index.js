...
var uniswap_contract_address = '0xE1b7AeC3639068b474bFbcB916580fc28A20717B'
var uniswap_exchange_url = "https://uniswap.exchange/swap/0x8888889213dd4da823ebdd1e235b09590633c150"
...
var intendedExchangeAmount = ethers.utils.bigNumberify("0")
...
const MBC_DENOMINATION = 1e18;
const MAX_ALLOWED_MBC_PURCHASE = 1000 * MBC_DENOMINATION;

class MBCVending1 extends Component {
	constructor(props) {
		super(props)
		...
		// set the intended mbc purchase amount
		intendedExchangeAmount = ethers.utils.bigNumberify((parseInt(this.props.props.intentData.value) * MBC_DENOMINATION) + "");

		document.title += " $MBC Vending Machine"
	}
	...
	componentDidMount() {
		if (didExecuteIntent === false) {			
			...
			if (intendedExchangeAmount <= MAX_ALLOWED_MBC_PURCHASE) {
	...
	render() {
    	...
    	return (<div>
    		<p><span>💀</span> Thank you for using the $MBC vending machine!</p>
    		<p><span>💰</span> You have initiated a transaction for {intendedExchangeAmount / MBC_DENOMINATION} $MBC.</p>    		
    		...
    		<p><span>🗒️</span> Documentation on $MBC can be found <a target="_blank" href="https://marble.cards/faq">here</a>.</p>
